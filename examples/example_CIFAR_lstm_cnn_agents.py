...
def main():
  ...
  save_path = f"./Havrylov_et_al/LSTMCNN/{rg_config['agent_loss_type']}/CIFAR10-OBS{rg_config['stimulus_resize_dim']}X{rg_config['stimulus_depth_dim']*rg_config['stimulus_depth_mult']}C"
