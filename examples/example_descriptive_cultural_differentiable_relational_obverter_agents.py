...
def test_example_cultural_obverter_agents():
  ...
  save_path += '-S{}L{}-{}-Reset{}-{}{}CulturalDiffRelObverter{}-{}GPR-S{}-{}-obs_b{}_lr{}-{}-tau0-{}-{}Distr{}-stim{}-vocab{}over{}_{}'.format(rg_config['cultural_speaker_substrate_size'], 
  ...
  from ReferentialGym.agents import DifferentiableRelationalObverterAgent
  ...
  bspeaker = DifferentiableRelationalObverterAgent(kwargs=agent_config, 
                                obs_shape=obs_shape, 
  ...
  blistener = DifferentiableRelationalObverterAgent(kwargs=agent_config, 
                                obs_shape=obs_shape, 
                                vocab_size=vocab_size, 
                                max_sentence_length=max_sentence_length,
                                agent_id='ol0',
