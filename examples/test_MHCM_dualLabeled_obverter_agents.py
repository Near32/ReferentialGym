...
def main():
  ...
  save_path += f"testMHCM/{'' if args.differentiable else 'Non'}DiffObverter-StopThresh{args.obverter_threshold_to_stop_message_generation}"

  if args.use_sentences_one_hot_vectors:
    save_path += f'+SentOneHotVec'
