...
def main():
  parser = argparse.ArgumentParser(description='Experiment 2: Interpolation and Extrapolation with Splitted Set.')
  ...
  save_path = f"./Havrylov_et_al/test_Stop0Start0/PAPER/EXP2/dSPrites/DualLabeled/MultiHead_{'Not' if not(multi_head_detached) else ''}Detached"
