...
# $1==SEED_BASIS  
# $2==ARCH( /BN+CNN3x3)
# $3==NBR_DISTRACTORS TRAIN (192 train + 64 test)
# $4==NBR_DISTRACTORS TEST (192 train + 64 test)
# $5==BATCH_SIZE (8/48/96/144/192)
...
--dataset dSprites \
--train_test_split_strategy combinatorial2-Y-2-S8-X-2-S8-Orientation-40-N-Scale-6-N-Shape-3-N \
--use_cuda \
--batch_size $5 &
#--shared_architecture \
#--fast \
