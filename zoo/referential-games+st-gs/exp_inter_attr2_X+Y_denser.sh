...
--dataset dSprites \
--train_test_split_strategy combinatorial2-Y-1-2-X-1-2-Orientation-40-N-Scale-6-N-Shape-3-N \
--use_cuda \
--batch_size $4 &
#--shared_architecture \
#--fast \
...
--max_sentence_length 20 --vocab_size 100 \
--dataset dSprites \
--train_test_split_strategy 2combinatorial2-Y-1-2-X-1-2-Orientation-40-N-Scale-6-N-Shape-3-N \
--use_cuda \
--batch_size $4 &
#--shared_architecture \
#--fast \
