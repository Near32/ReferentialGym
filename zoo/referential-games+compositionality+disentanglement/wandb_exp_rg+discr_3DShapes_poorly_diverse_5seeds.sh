...
--obverter_use_decision_head=True --obverter_nbr_head_outputs 2 \
--agent_loss_type $7 --graphtype $8 \
--metric_epoch_period 20 --nbr_train_points 150 --nbr_eval_points 100 --metric_batch_size 16 \
--dis_metric_resampling=True --metric_resampling=True --metric_active_factors_only=True \
