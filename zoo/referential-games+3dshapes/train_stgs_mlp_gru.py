...
def main():
  parser = argparse.ArgumentParser(description="STGS MLP-GRU Agents: Language Emergence on 3DShapesPyBullet Dataset.")
  ...
  if 'obverter' in args.graphtype:
    ...
    """
    from ReferentialGym.agents import MLPGRUCNNListener
    listener = MLPGRUCNNListener(
      kwargs=listener_config, 
      obs_shape=obs_shape, 
      vocab_size=vocab_size, 
      max_sentence_length=max_sentence_length,
